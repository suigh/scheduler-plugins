...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PowerSavingArgs)(nil), (*config.PowerSavingArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_PowerSavingArgs_To_config_PowerSavingArgs(a.(*PowerSavingArgs), b.(*config.PowerSavingArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.PowerSavingArgs)(nil), (*PowerSavingArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_PowerSavingArgs_To_v1beta3_PowerSavingArgs(a.(*config.PowerSavingArgs), b.(*PowerSavingArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta3_PowerSavingArgs_To_config_PowerSavingArgs(in *PowerSavingArgs, out *config.PowerSavingArgs, s conversion.Scope) error {
	if err := Convert_v1beta3_TrimaranSpec_To_config_TrimaranSpec(&in.TrimaranSpec, &out.TrimaranSpec, s); err != nil {
		return err
	}
...
// Convert_v1beta3_PowerSavingArgs_To_config_PowerSavingArgs is an autogenerated conversion function.
func Convert_v1beta3_PowerSavingArgs_To_config_PowerSavingArgs(in *PowerSavingArgs, out *config.PowerSavingArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_PowerSavingArgs_To_config_PowerSavingArgs(in, out, s)
}

func autoConvert_config_PowerSavingArgs_To_v1beta3_PowerSavingArgs(in *config.PowerSavingArgs, out *PowerSavingArgs, s conversion.Scope) error {
	if err := Convert_config_TrimaranSpec_To_v1beta3_TrimaranSpec(&in.TrimaranSpec, &out.TrimaranSpec, s); err != nil {
		return err
	}
...
// Convert_config_PowerSavingArgs_To_v1beta3_PowerSavingArgs is an autogenerated conversion function.
func Convert_config_PowerSavingArgs_To_v1beta3_PowerSavingArgs(in *config.PowerSavingArgs, out *PowerSavingArgs, s conversion.Scope) error {
	return autoConvert_config_PowerSavingArgs_To_v1beta3_PowerSavingArgs(in, out, s)
}
