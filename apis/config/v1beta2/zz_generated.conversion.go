...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PowerSavingArgs)(nil), (*config.PowerSavingArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_PowerSavingArgs_To_config_PowerSavingArgs(a.(*PowerSavingArgs), b.(*config.PowerSavingArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.PowerSavingArgs)(nil), (*PowerSavingArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_PowerSavingArgs_To_v1beta2_PowerSavingArgs(a.(*config.PowerSavingArgs), b.(*PowerSavingArgs), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1beta2_PowerSavingArgs_To_config_PowerSavingArgs is a manually generated conversion function.
func Convert_v1beta2_PowerSavingArgs_To_config_PowerSavingArgs(in *PowerSavingArgs, out *config.PowerSavingArgs, s conversion.Scope) error {
	return autoConvert_v1beta2_PowerSavingArgs_To_config_PowerSavingArgs(in, out, s)
}

func autoConvert_v1beta2_PowerSavingArgs_To_config_PowerSavingArgs(in *PowerSavingArgs, out *config.PowerSavingArgs, s conversion.Scope) error {
	if err := v1.Convert_Pointer_int64_To_int64(&in.LowCPUThreshold, &out.LowCPUThreshold, s); err != nil {
		return err
	}
	if err := v1.Convert_Pointer_int64_To_int64(&in.HighCPUThreshold, &out.HighCPUThreshold, s); err != nil {
		return err
	}
	// WARNING: in.MetricProvider requires manual conversion: does not exist in peer-type
	// Added manually
...
// Convert_config_PowerSavingArgs_To_v1beta2_PowerSavingArgs is a manually generated conversion function.
func Convert_config_PowerSavingArgs_To_v1beta2_PowerSavingArgs(in *config.PowerSavingArgs, out *PowerSavingArgs, s conversion.Scope) error {
	return autoConvert_config_PowerSavingArgs_To_v1beta2_PowerSavingArgs(in, out, s)
} 

func autoConvert_config_PowerSavingArgs_To_v1beta2_PowerSavingArgs(in *config.PowerSavingArgs, out *PowerSavingArgs, s conversion.Scope) error {
	// WARNING: in.TrimaranSpec requires manual conversion: does not exist in peer-type
	// Added manually
	if err := Convert_config_MetricProviderSpec_To_v1beta2_MetricProviderSpec(&in.TrimaranSpec.MetricProvider, &out.MetricProvider, s); err != nil {
		return err
	...
	if err := v1.Convert_int64_To_Pointer_int64(&in.LowCPUThreshold, &out.LowCPUThreshold, s); err != nil {
		return err
	}
	if err := v1.Convert_int64_To_Pointer_int64(&in.HighCPUThreshold, &out.HighCPUThreshold, s); err != nil {
		return err
	}
	return nil
}
