...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PowerSavingArgs) DeepCopyInto(out *PowerSavingArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.LowCPUThreshold != nil {
		in, out := &in.LowCPUThreshold, &out.LowCPUThreshold
		*out = new(int64)
		**out = **in
	}
	if in.HighCPUThreshold != nil {
		in, out := &in.HighCPUThreshold, &out.HighCPUThreshold
		*out = new(int64)
		**out = **in
	}
	in.MetricProvider.DeepCopyInto(&out.MetricProvider)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PowerSavingArgs.
func (in *PowerSavingArgs) DeepCopy() *PowerSavingArgs {
	if in == nil {
		return nil
	}
